...
* [deep tuto](https://www.tutorialrepublic.com/php-tutorial/)
* [overview tutorial](https://www.learn-php.org/)

## CheatSheet
* Source: [learnXinY](https://learnxinyminutes.com/docs/fr-fr/php-fr/)

Le code PHP doit être placé à l'intérieur de balises `<?php`. Si le fichier php ne contient que du code PHP, il est généralement recommandé de ne pas fermer la balise `?>`
...
Tout ce qui se trouve en dehors des <?php ?> est automatiquement affiché en sortie


### Types & Variables

* Les noms de variables débutent par le symbole `$`
* Un nom de variable valide commence par une lettre ou un underscore, suivi de n'importe quelle lettre, nombre ou de underscore.
...
// Les caractères spéciaux sont seulement échappés avec un back slash
...
### Constantes
* Une constante est déclarée avec `define()` et ne peut jamais être changée durant l'exécution.
* Un nom valide de constante commence par une lettre ou un underscore, suivi de n'importe quelle lettre, nombre ou underscores.
```php
...
// Un nom de fonction valide commence par une lettre ou un underscore,
// suivi de n'importe quelle lettre, nombre ou de underscores.
...
// Si le code dans my-file.php a déjà été inclus ailleurs, il ne va pas
// être inclus de nouveau.

require 'my-file.php';
require_once 'my-file.php';
// Même comportement que include() mais déclenche une erreur fatale si le fichier ne peux pas être inclus.
