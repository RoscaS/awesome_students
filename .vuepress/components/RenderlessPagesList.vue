...
export default {
  ...
  methods: {
    ...
    filterByAuthors() {
      this.filterIncludes("byAuthors", "frontmatter.authors")
    },
    filterByCategories() {
    ...
    filterOutByAuthors() {
      this.filterIncludes("notAuthors", "frontmatter.authors", true)
    },
    ...
    authors() {
      return compact(uniq(flatMap(this.pages, "frontmatter.authors"))).sort()
    },
    tags() {
